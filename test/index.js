...
'      catches errors when sync',
'*',
'',
'handles',
'   errors in assertions',
'      catches errors when async',
'*',
'',
'handles',
'   missing expectations',
'      requires at least one expect when sync',
'         No expectations were asserted!',
'',
'handles',
'   missing expectations',
'      requires at least one expect when async',
'         No expectations were asserted!',
'',
'4 tests failed!',
'\nFailed tests:',
